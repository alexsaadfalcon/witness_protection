...
def computeSwap(content_img, style_img):
...
#    plt.pause(1)
    ...
    for lr_rate in np.logspace(-2, 1, 4):
        for style_weight in np.logspace(1, 4, 4):
                    ...
                    for style_layers in combinations(layers, n):
                        ...
                        for ep in range(args.epoch+1):
                            ...
                            if ep%1000==0:
                                ...
                                output_name = 'results/' + args.output+'_%d'%(counter)+'.jpg'
